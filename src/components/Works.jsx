...
const ProjectCard = ({name, description, tags, image, source_code_link}) => {
    return (<motion.div variants={fadeIn("up", "spring")}>
        <Tilt
            options={{
        ...
        >
            ...
            <div className="mt-5">
                ...
                <p className="mt-2 text-secondary text-[14px] min-h-[300px]">{description}</p>
                <div
                    onClick={() => window.open(source_code_link, "_blank")}
                    className='flex items-center gap-2 p-2 bg-violet-800 text-white rounded-lg cursor-pointer hover:bg-violet-900 transition justify-center'>
                    <img src={github} alt="source code" className="w-[30px] object-contain"/>
                    <p>More info</p>
                </div>
            </div>
